...
public class Avanceinyeccion extends javax.swing.JFrame {
    ...
    //Saber si se ejecutará en la bd local o produccion
    String prod = "1";
    Inyeccion arr;
...
//            c = (prod.equals("1")) ? s.getconexionserver8("avances") : s.getconexionP("avances");
    ...
    /**
     * De igual manera, revisa en que bd tomara los datos, si de produccion o
     * local
     *
     * @return
     */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Avances para Inyección");
...
//                Nuevo objeto corrida
    ...
    /**
     * Formatea datos para mostrar en la interfaz, ademas de mostrar en el
     * combobox los puntos disponibles de acuerdo a la corrida
     *
     * @param i
     * @param c
     */
     ...
     * iniciar el objeto de tipo inyeccion para la siguiente funcion
     */
    private void setavanceinyeccion() {
        ...
        if (di.new_avanceinyeccion(getcon(), arr)) {
            JlResp.setText("Exito al agregar avance de inyeccion");
            vaciar();
        } else {
            JOptionPane.showMessageDialog(null,
